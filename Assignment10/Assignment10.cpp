...
int main(){
    ...
    jetA.distance=92;
    jetA.acceleration=(jetA.velocity_converted*jetA.velocity_converted)/(2*jetA.distance);//finish this michael
    ...
    */
    ...
    jetE.velocity_converted= (jetE.velocity*1000)/(60*60);        //I'm multiplying by 1000 to convert kilometers into meters.
