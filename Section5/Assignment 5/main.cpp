...
int main(){
   ...
   statIndex=0;
    ...
    hours=0;
    team="";
    //Player players[PLAYERS]={Player(163,15,189,"Team1"),Player(233,557,85,"Team1"),Player(124,9,87,"Team1"),Player(510,482,98,"Team1"),Player(134,159,35,"Team1"),Player(377,173,55,"Team2"),Player(56,92,25,"Team2"),Player(70,19,52,"Team2"),Player(43,69,22,"Team2"),Player(206,191,70,"Team2")};
   while(!fin.eof()){
        getline(fin,line);
        if((statIndex%4)==0){
